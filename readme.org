...
Es wird nur auf geometrische Veränderungen überprüft!
...
In der neuesten Version wurden ein paar interne Fehler behoben, so wurde der Puffer nicht korrekt berechnet und es wird jetzt im Vorher-Bild die Änderungen hervorgehoben.

grün - es wurde was ergänzt
rot - es wurde was gelöscht
gelb - es hat sich nur die Geometrie verändert
